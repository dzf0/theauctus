      ...
      <div className="w-full max-w-md">
        ...
        {sent ? (
          ...
          <div className="text-center">
            ...
            <p className="text-[13px] mb-2" style={{ color: "var(--foreground)" }}>
              Check your email
            </p>
            <p className="text-[12px] mb-8" style={{ color: "var(--muted)" }}>
              We sent a password reset link to<br />
              <span style={{ color: "var(--foreground)" }}>{email}</span>
            </p>
            <Link
              href="/auth/signin"
              className="inline-block px-6 py-3 liquid-btn text-[13px]"
            >
              ← Back to sign in
            </Link>
          </div>
